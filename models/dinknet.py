...
class DinkNet34_multiclass(nn.Module):
    def __init__(self, num_classes=16, num_channels=3):
        super(DinkNet34_multiclass, self).__init__()
...
class DinkNet34_three_stages(nn.Module):
    def __init__(self, num_classes=1, num_channels=3):
        super(DinkNet34_three_stages, self).__init__()
